...
<body>
  ...
  <div style="height: 100vh" class="container-fluid">
    <header>
      <h2 class="text-center p-2"><b>BPSU TRADERS</b></h2>
      <p class="text-center">
        Manufacturers And Suppliers of all types of Leather Goods and Corporate Gifts<br>
        <b>GST:</b> 27AZWPS0795D1ZO<br>
        <b>Address:</b> Baranggay tuyo Balanga city Bataan |
        <b>Mobile: </b>09898374632 | <b>E-mail id:</b> <a href="mailto:nathalie@gmail.com" style="text-decoration: none;color: black;">nathalie@gmail.com</a>
      </p>
    </header>
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
            ...
            <td rowspan="3" class="text-center p-3"><b>For, BPSU TRADERS</b></td>
          </tr>
          <tr>
            <td><b>IFSC Code</b></td>
            <td>IOBA0000330</td>
